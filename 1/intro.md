...
**为什么要使用DDD**
```
1. 软件为什么不能像真正的业务专家所想象的那样工作呢？
2. 随着时间的推移开发成本越来越高？
3. 软件存在相互矛盾的软件模型？
  
  在开发过程中，最大的鸿沟就是业务专家（领域专家）和开发者之间。业务专家将关注点放在交付业务价值上，而开发者将注意力放在技术实现上。
  并不是说开发者的动机是错误的，而是说开发者的眼光被自然而然地吸引到实现层面上。即使让业务专家和开发者一起工作，他们之间的协作也只是表面上的。
  这时所开发的软件便产生了一种映射（或者说翻译）：将业务员所想的映射到开发者所理解的。这样一来，软件不能完全反应出领域专家的思维模型。
...
1. 简化沟通，减少误解的风险
  ...
  这是因为当大家都使用相同的（通用）语言进行交流时，每个人都能听懂其他人说的。就是说业务专家、开发者和软件本身不存在"翻译"。
